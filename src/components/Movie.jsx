...
const Movie = ({ films }) => {
  ...
  const borderColor = (vote) => {
    if (vote <= 3) {
      return `text-xs rounded-full min-w-[30px] h-[30px] flex items-center justify-center border-2 border-[#E90000]`
    } else if (vote <= 5) {
      return `text-xs rounded-full min-w-[30px] h-[30px] flex items-center justify-center border-2 border-[#E97E00]`
    } else if (vote <= 7) {
      return `text-xs rounded-full min-w-[30px] h-[30px] flex items-center justify-center border-2 border-[#E9D100]`
    } else {
      return `text-xs rounded-full min-w-[30px] h-[30px] flex items-center justify-center border-2 border-[#66E900]`
    }
  }
